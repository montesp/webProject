  ...
  let books = [
    {
      ...
      "editorial": "Gigamesh",
      "descripcion": "Tras el largo verano, el invierno se acerca a los Siete" + 
      "Reinos. Lord Eddard Stark, señor de Invernalia, deja sus dominios para unirse a la" +
      "corte de su amigo el rey Robert Baratheon, llamado el Usurpador, hombre díscolo y" + 
      "otrora guerrero audaz cuyas mayores aficiones son comer, beber y engendrar" + 
      "bastardos. Eddard Stark ocupará el cargo de Mano del Rey e intentará desentrañar" + 
      " una maraña de intrigas que pondrá en peligro su vida y la de todos los suyos. En" + 
      " un mundo cuyas estaciones pueden durar decenios y en el que retazos de una magia" + 
      ...
      "autor": "Isaac Asimov",
      "editorial": "Edhasa",
      "descripcion": "Los robots de Isaac Asimov son máquinas capaces de llevar a" + 
      "cabo muy diversas tareas, y que a menudo se plantean a sí mismos problemas de" +
      "conducta humana. Pero estas cuestiones se resuelven en Yo, robot en el ámbito de" +
      "las tres leyes fundamentales de la robótica, concebidas por Asimov, y que no dejan" +
      "de proponer extraordinarias paradojas que a veces se explican por errores de" + 
      "funcionamiento y otras por la creciente complejidad de los programas. Las" +
